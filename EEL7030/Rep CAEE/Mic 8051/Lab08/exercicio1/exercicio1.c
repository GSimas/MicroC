...
void main()
{
	...
	while(1)
	{
		for(j=9;j>0;j--) 			//Loop de 0 a 9. Por algum motivo o EDSIM dá problema ao mostrar o "0"
		{
			for(i=0; i<6000; i++);	//Criando delay
			P1 = convert_7seg(j);	//Chama função e joga o dado da variável j nos displays 7seg
		}
		P1 = convert_7seg(0);
	}
